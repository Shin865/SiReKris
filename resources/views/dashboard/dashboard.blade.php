...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('tabler/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('tabler/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet" />
    <link href="{{ asset('tabler/assets/vendor/aos/aos.css') }}" rel="stylesheet" />
    <link href="{{ asset('tabler/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet" />
...
<body class="index-page">
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a class="btn-getstarted" href="/proseslogout">Logout</a>
        </div>
    </header>
            ...
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100" class="">
                        Laporkan masalah pasca bencana dengan SiReksis, aplikasi tanggap darurat yang cepat dan
                        efisien.<br />
                    </p>
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                        <a href="#about" class="btn-get-started">Mulai</a>
                        <a href="https://www.youtube.com/watch?v=1ysZFYpQORM&pp=ygUZYmVuY2FuYSBrYWJ1cGF0ZW4gY2VtcG9nbw%3D%3D"
                            class="glightbox btn-watch-video d-flex align-items-center"><i
                                class="bi bi-play-circle"></i><span>Tonton Video</span></a>
                    </div>
                    <img src="{{ asset('tabler/assets/img/hero-services-img.webp') }}" class="img-fluid hero-img"
                ...
                <div class="row gy-4">
                    <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="fst-italic">
                            ...
                            dapat disalurkan dengan cepat, serta meningkatkan kesadaran masyarakat akan pentingnya
                            pelaporan
                            kerusakan secara daring. Melalui penggunaan teknologi informasi, SiReKsis berupaya
                            menciptakan
                            komunitas yang lebih tanggap dan tangguh dalam menghadapi bencana alam.
                        </p>

                        <a href="#" class="read-more"><span>Ajukan Laporan</span><i
                    ...
                    <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            <div class="col-lg-6">
                                <img src="{{ asset('tabler/assets/img/about-company-1.jpg') }}" class="img-fluid"
                                    alt="" />
                            </div>
                            <div class="col-lg-6">
                                <div class="row gy-4">
                                    <div class="col-lg-12">
                                        <img src="{{ asset('tabler/assets/img/about-company-2.jpg') }}"
                                            class="img-fluid" alt="" />
                                    </div>
                                    <div class="col-lg-12">
                                        <img src="{{ asset('tabler/assets/img/about-company-3.jpg') }}"
                                            class="img-fluid" alt="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active show" data-bs-toggle="tab"
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Memfasilitasi pelaporan kerusakan secara cepat dan mudah, memungkinkan pihak
                                            berwenang untuk menerima informasi
                                            yang akurat mengenai kondisi lapangan. Fitur ini memastikan bahwa setiap
                                            laporan kerusakan dapat ditindaklanjuti
                                            dengan tepat dan efisien, membantu dalam koordinasi dan alokasi sumber daya
                                            untuk penanganan bencana yang efektif.
                                        </p>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-2">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Menampilkan jumlah laporan kerusakan yang diterima, diajukan, maupun
                                            ditolak. Fitur ini memberikan gambaran lengkap tentang status setiap
                                            laporan,
                                            membantu pihak berwenang dalam memonitor dan mengevaluasi tanggapan terhadap
                                            setiap insiden. Dengan demikian, keputusan dapat dibuat
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-3">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Mengorganisir data dengan baik untuk memudahkan analisis dan pengambilan
                                            keputusan. Fitur ini memastikan
                                            tindakan yang cepat dan tepat sesuai dengan kondisi lapangan, sehingga tim
                                            tanggap darurat dapat merespons dengan efektif dan efisien.
                                        </p>
                                    </div>
                                </a>
                            </li>
                    ...
                    <div class="col-lg-6">
                        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                            <div class="tab-pane fade active show" id="features-tab-1">
                                <img src="{{ asset('tabler/assets/img/tabs-1.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-2">
                                <img src="{{ asset('tabler/assets/img/tabs-2.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-3">
                                <img src="{{ asset('tabler/assets/img/tabs-3.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <!-- End Tab Content Item -->
                        </div>
                        ...
                        <div class="service-item item-red position-relative">
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    menampilkan jumlah laporan yang diterima, diajukan, dan ditolak. Rekapitulasi ini
                                    dapat diakses oleh semua pihak yang berkepentingan, memudahkan untuk
                                    memantau perkembangan dan status laporan secara transparan. Dengan tampilan
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        ...
                                        3. Isi formulir laporan dengan detail informasi kerusakan, seperti lokasi,
                                        deskripsi kerusakan, dan foto jika memungkinkan.<br>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        ...
                                        2. Pihak berwenang akan mengevaluasi dan mengambil tindakan yang diperlukan
                                        untuk memperbaiki kerusakan.<br>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-md-3 footer-links">
                    ...
                    <ul>
                        ...
                        <li><a
                                href="https://www.detik.com/jateng/berita/d-7221457/rusak-berat-tertimpa-longsor-1-rumah-di-cepogo-boyolali-dirobohkan">Berita</a>
                        </li>
                ...
                <div class="col-lg-2 col-md-3 footer-links">
                    ...
                    <ul>
                        <li><a href="/pelaporan">lapor</a></li>
                        <li><a href="/pelaporan">laporanmu</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4 col-md-12 footer-newsletter">
                    <h4>Visi</h4>
                    <p>
                        Menjadi platform pelaporan bencana yang terdepan, menyediakan informasi yang akurat, serta
                        memfasilitasi koordinasi respons yang cepat dan efektif.!
                    </p>
                </div>
            </div>
        </div>
