...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
            ...
            <tr>
                ...
                <td style="width: 75%; text-align: center">
                    <p><strong>LAPORAN KERUSAKAN BENCANA</strong><br>
                        ...
                        Tumang Krajan, RT.005/RW.014, Dusun III, Cepogo, Boyolali Regency, Central Java 57362
                    </p>
                </td>
                <td style="width: 10%">
        ...
        <p>Izin menyampaikan laporan kerusakan yang diakibatkan oleh <b>{{ $laporan->bencana }}</b> dengan deskripsi
            sebagai berikut :</p>
        ...
        <p>Demikian surat ini kami buat dengan sebenarnya, atas perhatian dan kerjasamanya kami ucapkan terima kasih.
        </p>
