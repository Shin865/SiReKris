<form action="/pelaporan/{{ $pelaporan->kode_lapor }}/update" method="POST" id="formPelaporan" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-12">
        <div class="input-icon mb-3">
          ...
          <input type="text" readonly id="kode_lapor" value="{{ $pelaporan->kode_lapor }}" class="form-control" name="Kode_lapor" placeholder="Kode Laporan">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <div class="input-icon mb-3">
          ...
          <input type="text" id="penanggung" value="{{ $pelaporan->penanggung }}" name="penanggung" class="form-control" placeholder="Penanggung Jawab">
        </div>
      </div>
    </div>
    <div class="row">
        <div class="col-12">
          <div class="input-icon mb-3">
            ...
            <input type="text" id="alamat" value="{{ $pelaporan->alamat }}" class="form-control" name="alamat" placeholder="Alamat">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
          <div class="input-icon mb-3">
            ...
            <input type="text" id="bencana" value="{{ $pelaporan->bencana }}" class="form-control" name="Bencana" placeholder="Bencana">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
          <div class="input-icon mb-3">
            ...
            <input type="text" id="no_hp" value="{{ $pelaporan->no_hp}}" class="form-control" name="no_hp" placeholder="No.HP">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
            <textarea id="deskripsi" class="form-control" name="deskripsi" placeholder="Deskripsi Bencana">{{ $pelaporan->deskripsi }}</textarea>
        </div>
      </div>
      <div class="row mt-2">
        <div class="col-12">
          <input type="date" name="tanggal" class="form-control" value="{{ $pelaporan->tanggal }}">
        </div>
      </div>
      <div class="row mt-2">
        <div class="col-12">
            <input type="file" name="foto" class="form-control">
            <input type="hidden" name="foto_lama" value="{{ $pelaporan->foto }}">
        </div>
      </div>
<div class="row mt-2">
<div class="col-12">
