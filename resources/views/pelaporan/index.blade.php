                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <input type="text" name="bencana" id="bencana" class="form-control"
                                                    placeholder="Cari Jenis Bencana" value="{{ Request('bencana') }}">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        @if ($item->status == '0' || $item->status == '2')
                                                            <div>
                                                                <a href="#" class="edit btn btn-info mr-3"
                                                            ...
                                                            <div>
                                                                <form action="/pelaporan/{{ $item->kode_lapor }}/delete"
                                                                    method="POST" style="margin-left:5px">
                                                                    @csrf
                                                                    <a class="btn btn-danger delete-confirm"><svg
                                                        ...
                                                        @else
                                                            <form action="/laporan/cetaklaporan" target="_blank"
                                                                method="POST">
                                                                @csrf
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" id="penanggung" value="" name="penanggung"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" id="bencana" value="" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        <span class="input-icon-addon">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="icon icon-tabler icon-tabler-file-phone" width="24"
                                                height="24" viewBox="0 0 24 24" stroke-width="2"
                                                stroke="currentColor" fill="none" stroke-linecap="round"
                                                stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
