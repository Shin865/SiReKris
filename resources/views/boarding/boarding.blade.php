...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('tabler/assets/img/favicon.png') }}" rel="icon" />
    <link href="{{ asset('tabler/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon" />
      ...
      >
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="index.html#features">Lapor</a></li>
          </ul>
          ...
          <div class="row gy-4">
            ...
            >
              <div class="service-item d-flex">
                ...
                <div>
                  <h4 class="title">
                    <a href="#" class="stretched-link">Laporan Acc</a>
                  </h4>
                  <p class="description">
                    10
                  </p>
        ...
        <div class="container" data-aos="fade-up">
          <div class="row gy-4">
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img
                src="{{ asset('tabler/assets/img/clients/client-1.png') }}"
                class="img-fluid"
                alt=""
              />
            </div>
            ...
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img
                src="{{ asset('tabler/assets/img/clients/client-2.png') }}"
                class="img-fluid"
                alt=""
              />
            </div>
            ...
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img
                src="{{ asset('tabler/assets/img/clients/client-3.png') }}"
                class="img-fluid"
                alt=""
              />
            </div>
            ...
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img
                src="{{ asset('tabler/assets/img/clients/client-4.png') }}"
                class="img-fluid"
                alt=""
              />
            </div>
            ...
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img
                src="{{ asset('tabler/assets/img/clients/client-5.png') }}"
                class="img-fluid"
                alt=""
              />
            </div>
            ...
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img
                src="{{ asset('tabler/assets/img/clients/client-6.png') }}"
                class="img-fluid"
                alt=""
              />
            </div>
        ...
        <div class="container">
          <div class="row gy-4 justify-content-between features-item">
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              <img src="{{ asset('tabler/assets/img/features-1.jpg') }}" class="img-fluid" alt="" />
            </div>
          ...
          <div class="row gy-4 justify-content-between features-item">
            ...
            <div
              ...
              data-aos-delay="200"
            >
              <img src="{{ asset('tabler/assets/img/features-2.jpg') }}" class="img-fluid" alt="" />
            </div>
          </div>
          <!-- Features Item -->
        </div>
        ...
        <div class="container">
          <div class="row justify-content-around gy-4">
            ...
            <div
              ...
              data-aos-delay="200"
            >
              <img src="{{ asset('tabler/assets/img/features-3.jpg') }}" alt="" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="testimonial-item">
                  ...
                  <div class="profile mt-auto">
                    <img
                      src="{{ asset('tabler/assets/img/testimonials/testimonials-2.jpg') }}"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>Sara Wilsson</h3>
              ...
              <div class="swiper-slide">
                <div class="testimonial-item">
                  ...
                  <div class="profile mt-auto">
                    <img
                      src="{{ asset('tabler/assets/img/testimonials/testimonials-3.jpg') }}"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>Jena Karlis</h3>
              ...
              <div class="swiper-slide">
                <div class="testimonial-item">
                  ...
                  <div class="profile mt-auto">
                    <img
                      src="{{ asset('tabler/assets/img/testimonials/testimonials-4.jpg') }}"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>Matt Brandon</h3>
              ...
              <div class="swiper-slide">
                <div class="testimonial-item">
                  ...
                  <div class="profile mt-auto">
                    <img
                      src="{{ asset('tabler/assets/img/testimonials/testimonials-5.jpg') }}"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>John Larson</h3>
