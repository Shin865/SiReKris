        ...
        <form class="card card-md" action="/akun/register" method="POST" id="formregis" autocomplete="off" novalidate>
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="nama_pela" id="nama_pela" class="form-control" placeholder="Enter name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="no_hp" id="no_hp" class="form-control" placeholder="Enter phone number">
            </div>
            <div class="mb-3">
