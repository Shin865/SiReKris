        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    @endphp
                    <form action="/profil/{id_pela}/updateprofile" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                              <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_pela" value="{{ $pelapor->nama_pela }}" class="form-control" name="nama_pela" placeholder="Nama Lengkap">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-12">
                              <div class="input-icon mb-3">
                                ...
                                <input type="text" id="email_pela" value="{{ $pelapor->email_pela }}" name="email_pela" class="form-control" placeholder="Email">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-12">
                              <div class="input-icon mb-3">
                                ...
                                <input type="password" id="password" value="{{ $pelapor->password }}" name="password" class="form-control" placeholder="Password">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-12">
                              <div class="input-icon mb-3">
                                ...
                                <input type="text" id="no_hp" value="{{ $pelapor->no_hp }}" name="no_hp" class="form-control" placeholder="No.HP">
                              </div>
                            </div>
                          </div>
                <div class="row mt-2">
