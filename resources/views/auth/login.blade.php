          ...
          <div class="col-lg">
            <div class="container-tight">
              ...
              <div class="card card-md">
                <div class="card-body">
                  <h2 class="h2 text-center mb-4">Login Pelaporan</h2>
                  ...
                  <form action="/proseslogin" method="POST" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" name="email_pela" id="email_pela" class="form-control" placeholder="your@email.com" autocomplete="off">
                    </div>
                    <div class="mb-2">
